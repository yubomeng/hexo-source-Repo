...
copyright_url: https://blog.wuyuxi.cn/posts/tagplugins.html
ai: 
...
`AnZhiYu主题`中大部分标签移植于[店长](https://akilar.top/)的[hexo-butterfly-tag-plugins-plus](https://www.npmjs.com/package/hexo-butterfly-tag-plugins-plus)，转载请注明来自[](https://blog.anheyu.com/posts/d50a.html)
{% endnote %} -->

...
top_img: "https://cdnjson.com/images/2023/10/28/4.webp"
cover: "https://cdnjson.com/images/2023/10/28/4.webp"
ai:
...
# {% note red 'anzhiyufont anzhiyu-icon-fan' simple%}前言{% endnote %}
...
# {% note pink 'anzhiyufont anzhiyu-icon-bullhorn' simple%}目前最好的解决办法就是使用图床来存储图片{% endnote %}
